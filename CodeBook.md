...
Finnaly, we created tidy dataset that contains mean values of mean value and standart deviation grouped by Subject and Activity:
- Subject - ID of a subject who perform activity
